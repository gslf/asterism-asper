 ...
 *
 * Threads via pthreads (compiled out under ASPER_NO_THREADS — os_common.c
...
typedef int asper_os_posix_unused_on_win32; /* non-empty translation unit */
