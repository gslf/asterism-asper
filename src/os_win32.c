 ...
 * Threading section compiles out under ASPER_NO_THREADS (os_common.c then
    ...
    *out_n = 0;
    ...
    if (h == INVALID_HANDLE_VALUE) {
        ...
        if (err == ERROR_FILE_NOT_FOUND || err == ERROR_PATH_NOT_FOUND ||
            ...
            return ASPER_OK; /* missing dir => 0 entries */
        return ASPER_ERR_IO;
    }
...
typedef int asper_os_win32_unused_on_posix; /* non-empty translation unit */
